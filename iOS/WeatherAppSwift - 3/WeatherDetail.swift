...
//  WeatherAppSwift - 3
//
//  Created by Melih Cüneyter on 5.01.2022.
//
...
class WeatherDetail: WeatherLocation {
    ...
    func getData(completed: @escaping () -> ()) {
        let urlString = "https://api.openweathermap.org/data/2.5/onecall?lat=\(latitude)&lon=\(longitude)&appid=\(APIKeys.openWeatherKey)&units=metric&lang=tr"
